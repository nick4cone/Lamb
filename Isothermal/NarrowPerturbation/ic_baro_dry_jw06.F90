module ic_baro_dry_jw06
  ...
  real(r8), parameter, private ::             &
       T0                     = 275._r8,      & ! horizontal mean T at the surface in K
       p00                    = 1.e5_r8,      & ! reference surface pressure in Pa
       mountain_halfwidth     = 1._r8/90._r8, & ! halfwidth of the Gaussian mountain without Earth's radius=1 (a/10 with a=1) 
